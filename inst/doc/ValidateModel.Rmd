...
#### 7. Sum of each cell across all state Use tables must almost equal (<= 0.001) the same cell in US Use table. This validates that Total state demand == Total national demand.
