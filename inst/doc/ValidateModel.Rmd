...
```{r report-results}
# GA
cat("##### 17.1 Georgia and Rest of the US\n")
reportValidationResult(GA_failures)
# MN
cat("##### 17.2 Minnesota and Rest of the US\n")
reportValidationResult(MN_failures)
# OR
cat("##### 17.3 Oregon and Rest of the US\n")
reportValidationResult(OR_failures)
# WA
cat("##### 17.4 Washington and Rest of the US\n")
