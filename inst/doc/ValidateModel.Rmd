...
for (state in states[states!="Overseas"]) {
  ...
  q_use <- rowSums(TwoRegionTable_ls[[state]][["SoI2SoI"]][, c(industries, FD_cols)]) +
    rowSums(TwoRegionTable_ls[[state]][["RoUS2SoI"]][, c(industries, FD_cols)])
...
# df1 <- Reduce("+", lapply(State_Summary_Make_ls, function(x) rowSums(x)))
